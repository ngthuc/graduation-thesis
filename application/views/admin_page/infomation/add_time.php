    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Thêm mới thông tin dạng thời gian (year - year)</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="add-time" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                Từ
                <input type="text" class="form-control" name="time" id="time" placeholder="Nhập năm bắt đầu">
              </div>
              <div class="col-sm-6">
                đến
               <input type="text" class="form-control" name="to_year" id="to_year" placeholder="Nhập năm kết thúc">
              </div>
            </div>
            <div class="form-group">
              <div class="row">
