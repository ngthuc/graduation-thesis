...
--
-- Host: localhost
-- Generation Time: Oct 31, 2018 at 03:56 AM
...
--
-- Database: `luanvan_joomla`
--

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_assets`
--

CREATE TABLE IF NOT EXISTS `luanvan_assets` (
...
--
-- Dumping data for table `luanvan_assets`
--

INSERT INTO `luanvan_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `luanvan_associations`
--

CREATE TABLE IF NOT EXISTS `luanvan_associations` (
...
--
-- Table structure for table `luanvan_banners`
--

CREATE TABLE IF NOT EXISTS `luanvan_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `luanvan_banner_clients`
--

CREATE TABLE IF NOT EXISTS `luanvan_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `luanvan_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `luanvan_banner_tracks` (
...
--
-- Table structure for table `luanvan_categories`
--

CREATE TABLE IF NOT EXISTS `luanvan_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `luanvan_categories`
--

INSERT INTO `luanvan_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `luanvan_contact_details`
--

CREATE TABLE IF NOT EXISTS `luanvan_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `luanvan_content`
--

CREATE TABLE IF NOT EXISTS `luanvan_content` (
...
--
-- Table structure for table `luanvan_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `luanvan_contentitem_tag_map` (
...
--
-- Table structure for table `luanvan_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `luanvan_content_frontpage` (
...
--
-- Table structure for table `luanvan_content_rating`
--

CREATE TABLE IF NOT EXISTS `luanvan_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `luanvan_content_types`
--

CREATE TABLE IF NOT EXISTS `luanvan_content_types` (
...
--
-- Dumping data for table `luanvan_content_types`
--

INSERT INTO `luanvan_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `luanvan_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `luanvan_core_log_searches` (
...
--
-- Table structure for table `luanvan_extensions`
--

CREATE TABLE IF NOT EXISTS `luanvan_extensions` (
...
--
-- Dumping data for table `luanvan_extensions`
--

INSERT INTO `luanvan_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"80efeeca004ef9c70f0af6380045940d"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `luanvan_finder_filters`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_filters` (
...
--
-- Table structure for table `luanvan_finder_links`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links` (
...
--
-- Table structure for table `luanvan_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `luanvan_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `luanvan_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `luanvan_finder_taxonomy`
--

INSERT INTO `luanvan_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `luanvan_finder_terms`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `luanvan_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `luanvan_finder_terms_common`
--

INSERT INTO `luanvan_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `luanvan_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `luanvan_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `luanvan_finder_types`
--

CREATE TABLE IF NOT EXISTS `luanvan_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `luanvan_languages`
--

CREATE TABLE IF NOT EXISTS `luanvan_languages` (
...
--
-- Dumping data for table `luanvan_languages`
--

INSERT INTO `luanvan_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_menu`
--

CREATE TABLE IF NOT EXISTS `luanvan_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `luanvan_menu`
--

INSERT INTO `luanvan_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `luanvan_menu_types`
--

CREATE TABLE IF NOT EXISTS `luanvan_menu_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `luanvan_menu_types`
--

INSERT INTO `luanvan_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_messages`
--

CREATE TABLE IF NOT EXISTS `luanvan_messages` (
...
--
-- Table structure for table `luanvan_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `luanvan_messages_cfg` (
...
--
-- Table structure for table `luanvan_modules`
--

CREATE TABLE IF NOT EXISTS `luanvan_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `luanvan_modules`
--

INSERT INTO `luanvan_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `luanvan_modules_menu`
--

CREATE TABLE IF NOT EXISTS `luanvan_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `luanvan_modules_menu`
--

INSERT INTO `luanvan_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `luanvan_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `luanvan_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `luanvan_overrider`
--

CREATE TABLE IF NOT EXISTS `luanvan_overrider` (
...
--
-- Table structure for table `luanvan_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `luanvan_postinstall_messages` (
...
--
-- Dumping data for table `luanvan_postinstall_messages`
--

INSERT INTO `luanvan_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `luanvan_redirect_links`
--

CREATE TABLE IF NOT EXISTS `luanvan_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `luanvan_schemas`
--

CREATE TABLE IF NOT EXISTS `luanvan_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `luanvan_schemas`
--

INSERT INTO `luanvan_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-02-26');

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_session`
--

CREATE TABLE IF NOT EXISTS `luanvan_session` (
...
--
-- Dumping data for table `luanvan_session`
--

INSERT INTO `luanvan_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('a7sm20ca6uaej9l5oddtehma33', 0, 1, '1540908441', 'joomla|s:1552:"";', 0, ''),
('jdf8frj68tgk1496aksmd14vo2', 0, 1, '1540957667', 'joomla|s:1552:"";', 0, ''),
('rimi2t4usplur6v13vlnrt9ae6', 0, 1, '1540957667', 'joomla|s:1552:"";', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_tags`
--

CREATE TABLE IF NOT EXISTS `luanvan_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `luanvan_tags`
--

INSERT INTO `luanvan_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Table structure for table `luanvan_template_styles`
--

CREATE TABLE IF NOT EXISTS `luanvan_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `luanvan_template_styles`
--

INSERT INTO `luanvan_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `luanvan_ucm_base`
--

CREATE TABLE IF NOT EXISTS `luanvan_ucm_base` (
...
--
-- Table structure for table `luanvan_ucm_content`
--

CREATE TABLE IF NOT EXISTS `luanvan_ucm_content` (
...
--
-- Table structure for table `luanvan_ucm_history`
--

CREATE TABLE IF NOT EXISTS `luanvan_ucm_history` (
...
--
-- Table structure for table `luanvan_updates`
--

CREATE TABLE IF NOT EXISTS `luanvan_updates` (
...
--
-- Dumping data for table `luanvan_updates`
--

INSERT INTO `luanvan_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.6.5.2', '', 'https://update.joomla.org/language/details3/bg-BG_details.xml', '', ''),
(2, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
(3, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/zh-CN_details.xml', '', ''),
(4, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.8.5.1', '', 'https://update.joomla.org/language/details3/hr-HR_details.xml', '', ''),
(5, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(6, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(7, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(8, 3, 0, 'Esperanto', '', 'pkg_eo-XX', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/eo-XX_details.xml', '', ''),
(9, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.8.10.1', '', 'https://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(10, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(11, 3, 0, 'Khmer', '', 'pkg_km-KH', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/km-KH_details.xml', '', ''),
(12, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.8.9.1', '', 'https://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
(13, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.7.3.1', '', 'https://update.joomla.org/language/details3/lv-LV_details.xml', '', ''),
(14, 3, 0, 'Lithuanian', '', 'pkg_lt-LT', 'package', '', 0, '3.8.10.1', '', 'https://update.joomla.org/language/details3/lt-LT_details.xml', '', ''),
(15, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(16, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
(17, 3, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '3.4.2.1', '', 'https://update.joomla.org/language/details3/nn-NO_details.xml', '', ''),
(18, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(19, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.8.11.2', '', 'https://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
(20, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/pt-PT_details.xml', '', ''),
(21, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(22, 3, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(23, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(24, 3, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(25, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(26, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(27, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(28, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(29, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(30, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.7.1.1', '', 'https://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
(31, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/ug-CN_details.xml', '', ''),
(32, 3, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.2', '', 'https://update.joomla.org/language/details3/sq-AL_details.xml', '', ''),
(33, 3, 0, 'Basque', '', 'pkg_eu-ES', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/eu-ES_details.xml', '', ''),
(34, 3, 0, 'Hindi', '', 'pkg_hi-IN', 'package', '', 0, '3.3.6.2', '', 'https://update.joomla.org/language/details3/hi-IN_details.xml', '', ''),
(35, 3, 0, 'German DE', '', 'pkg_de-DE', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(36, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(37, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(38, 1, 700, 'Joomla', '', 'joomla', 'file', '', 0, '3.6.5', '', 'https://update.joomla.org/core/sts/extension_sts.xml', '', ''),
(39, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.8.12.2', '', 'https://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(40, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(41, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
(42, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.2', '', 'https://update.joomla.org/language/details3/vi-VN_details.xml', '', ''),
(43, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.6.2.1', '', 'https://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(44, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.8.1.1', '', 'https://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(45, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(46, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.2', '', 'https://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(47, 3, 0, 'English CA', '', 'pkg_en-CA', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
(48, 3, 0, 'French CA', '', 'pkg_fr-CA', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
(49, 3, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.8.5.1', '', 'https://update.joomla.org/language/details3/cy-GB_details.xml', '', ''),
(50, 3, 0, 'Sinhala', '', 'pkg_si-LK', 'package', '', 0, '3.3.1.2', '', 'https://update.joomla.org/language/details3/si-LK_details.xml', '', ''),
(51, 3, 0, 'Dari Persian', '', 'pkg_prs-AF', 'package', '', 0, '3.4.4.2', '', 'https://update.joomla.org/language/details3/prs-AF_details.xml', '', ''),
(52, 3, 0, 'Turkmen', '', 'pkg_tk-TM', 'package', '', 0, '3.5.0.2', '', 'https://update.joomla.org/language/details3/tk-TM_details.xml', '', ''),
(53, 3, 0, 'Irish', '', 'pkg_ga-IE', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/ga-IE_details.xml', '', ''),
(54, 3, 0, 'Dzongkha', '', 'pkg_dz-BT', 'package', '', 0, '3.6.2.1', '', 'https://update.joomla.org/language/details3/dz-BT_details.xml', '', ''),
(55, 3, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/sl-SI_details.xml', '', ''),
(56, 3, 0, 'Spanish CO', '', 'pkg_es-CO', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/es-CO_details.xml', '', ''),
(57, 3, 0, 'German CH', '', 'pkg_de-CH', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/de-CH_details.xml', '', ''),
(58, 3, 0, 'German AT', '', 'pkg_de-AT', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/de-AT_details.xml', '', ''),
(59, 3, 0, 'German LI', '', 'pkg_de-LI', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/de-LI_details.xml', '', ''),
(60, 3, 0, 'German LU', '', 'pkg_de-LU', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/de-LU_details.xml', '', ''),
(61, 3, 0, 'English NZ', '', 'pkg_en-NZ', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/en-NZ_details.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_update_sites`
--

CREATE TABLE IF NOT EXISTS `luanvan_update_sites` (
...
--
-- Dumping data for table `luanvan_update_sites`
--

INSERT INTO `luanvan_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1540338149, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1540338149, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1540338147, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1540338147, '');

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `luanvan_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';

--
-- Dumping data for table `luanvan_update_sites_extensions`
--

INSERT INTO `luanvan_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Table structure for table `luanvan_usergroups`
--

CREATE TABLE IF NOT EXISTS `luanvan_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `luanvan_usergroups`
--

INSERT INTO `luanvan_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `luanvan_users`
--

CREATE TABLE IF NOT EXISTS `luanvan_users` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `luanvan_users`
--

INSERT INTO `luanvan_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(172, 'Super User', 'ngthuc', 'thuc.edu@gmail.com', '$2y$10$leOh2FlAEcHkoonEGAk/Tu9HM5mFUhY4gm2rD/xd0AAqpY1dhLPAa', 0, 1, '2018-07-27 14:55:38', '2018-10-23 23:49:43', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_user_keys`
--

CREATE TABLE IF NOT EXISTS `luanvan_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `luanvan_user_notes`
--

CREATE TABLE IF NOT EXISTS `luanvan_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `luanvan_user_profiles`
--

CREATE TABLE IF NOT EXISTS `luanvan_user_profiles` (
...
--
-- Table structure for table `luanvan_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `luanvan_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `luanvan_user_usergroup_map`
--

INSERT INTO `luanvan_user_usergroup_map` (`user_id`, `group_id`) VALUES
(172, 8);

-- --------------------------------------------------------

--
-- Table structure for table `luanvan_viewlevels`
--

CREATE TABLE IF NOT EXISTS `luanvan_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `luanvan_viewlevels`
--

INSERT INTO `luanvan_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `luanvan_assets`
--
ALTER TABLE `luanvan_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_associations`
--
ALTER TABLE `luanvan_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `luanvan_banners`
--
ALTER TABLE `luanvan_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_banner_clients`
--
ALTER TABLE `luanvan_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`);

--
-- Indexes for table `luanvan_banner_tracks`
--
ALTER TABLE `luanvan_banner_tracks`
...
--
-- Indexes for table `luanvan_categories`
--
ALTER TABLE `luanvan_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_contact_details`
--
ALTER TABLE `luanvan_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `luanvan_content`
--
ALTER TABLE `luanvan_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `luanvan_contentitem_tag_map`
--
ALTER TABLE `luanvan_contentitem_tag_map`
...
--
-- Indexes for table `luanvan_content_frontpage`
--
ALTER TABLE `luanvan_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `luanvan_content_rating`
--
ALTER TABLE `luanvan_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `luanvan_content_types`
--
ALTER TABLE `luanvan_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`);

--
-- Indexes for table `luanvan_extensions`
--
ALTER TABLE `luanvan_extensions`
...
--
-- Indexes for table `luanvan_finder_filters`
--
ALTER TABLE `luanvan_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `luanvan_finder_links`
--
ALTER TABLE `luanvan_finder_links`
...
--
-- Indexes for table `luanvan_finder_links_terms0`
--
ALTER TABLE `luanvan_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_terms1`
--
ALTER TABLE `luanvan_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_terms2`
--
ALTER TABLE `luanvan_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_terms3`
--
ALTER TABLE `luanvan_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_terms4`
--
ALTER TABLE `luanvan_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_terms5`
--
ALTER TABLE `luanvan_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_terms6`
--
ALTER TABLE `luanvan_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_terms7`
--
ALTER TABLE `luanvan_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_terms8`
--
ALTER TABLE `luanvan_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_terms9`
--
ALTER TABLE `luanvan_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_termsa`
--
ALTER TABLE `luanvan_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_termsb`
--
ALTER TABLE `luanvan_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_termsc`
--
ALTER TABLE `luanvan_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_termsd`
--
ALTER TABLE `luanvan_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_termse`
--
ALTER TABLE `luanvan_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_links_termsf`
--
ALTER TABLE `luanvan_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `luanvan_finder_taxonomy`
--
ALTER TABLE `luanvan_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_finder_taxonomy_map`
--
ALTER TABLE `luanvan_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `luanvan_finder_terms`
--
ALTER TABLE `luanvan_finder_terms`
...
--
-- Indexes for table `luanvan_finder_terms_common`
--
ALTER TABLE `luanvan_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `luanvan_finder_tokens`
--
ALTER TABLE `luanvan_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `luanvan_finder_tokens_aggregate`
--
ALTER TABLE `luanvan_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `luanvan_finder_types`
--
ALTER TABLE `luanvan_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `luanvan_languages`
--
ALTER TABLE `luanvan_languages`
...
--
-- Indexes for table `luanvan_menu`
--
ALTER TABLE `luanvan_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_menu_types`
--
ALTER TABLE `luanvan_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `luanvan_messages`
--
ALTER TABLE `luanvan_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `luanvan_messages_cfg`
--
ALTER TABLE `luanvan_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `luanvan_modules`
--
ALTER TABLE `luanvan_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_modules_menu`
--
ALTER TABLE `luanvan_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `luanvan_newsfeeds`
--
ALTER TABLE `luanvan_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `luanvan_overrider`
--
ALTER TABLE `luanvan_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `luanvan_postinstall_messages`
--
ALTER TABLE `luanvan_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `luanvan_redirect_links`
--
ALTER TABLE `luanvan_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_link_old` (`old_url`),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `luanvan_schemas`
--
ALTER TABLE `luanvan_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `luanvan_session`
--
ALTER TABLE `luanvan_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `luanvan_tags`
--
ALTER TABLE `luanvan_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_template_styles`
--
ALTER TABLE `luanvan_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `luanvan_ucm_base`
--
ALTER TABLE `luanvan_ucm_base`
...
--
-- Indexes for table `luanvan_ucm_content`
--
ALTER TABLE `luanvan_ucm_content`
...
--
-- Indexes for table `luanvan_ucm_history`
--
ALTER TABLE `luanvan_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `luanvan_updates`
--
ALTER TABLE `luanvan_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `luanvan_update_sites`
--
ALTER TABLE `luanvan_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `luanvan_update_sites_extensions`
--
ALTER TABLE `luanvan_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `luanvan_usergroups`
--
ALTER TABLE `luanvan_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_users`
--
ALTER TABLE `luanvan_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_user_keys`
--
ALTER TABLE `luanvan_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `luanvan_user_notes`
--
ALTER TABLE `luanvan_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `luanvan_user_profiles`
--
ALTER TABLE `luanvan_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `luanvan_user_usergroup_map`
--
ALTER TABLE `luanvan_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `luanvan_viewlevels`
--
ALTER TABLE `luanvan_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `luanvan_assets`
--
ALTER TABLE `luanvan_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT for table `luanvan_banners`
--
ALTER TABLE `luanvan_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_banner_clients`
--
ALTER TABLE `luanvan_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_categories`
--
ALTER TABLE `luanvan_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `luanvan_contact_details`
--
ALTER TABLE `luanvan_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_content`
--
ALTER TABLE `luanvan_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_content_types`
--
ALTER TABLE `luanvan_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `luanvan_extensions`
--
ALTER TABLE `luanvan_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=701;
--
-- AUTO_INCREMENT for table `luanvan_finder_filters`
--
ALTER TABLE `luanvan_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_finder_links`
--
ALTER TABLE `luanvan_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_finder_taxonomy`
--
ALTER TABLE `luanvan_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `luanvan_finder_terms`
--
ALTER TABLE `luanvan_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_finder_types`
--
ALTER TABLE `luanvan_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_languages`
--
ALTER TABLE `luanvan_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `luanvan_menu`
--
ALTER TABLE `luanvan_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=102;
--
-- AUTO_INCREMENT for table `luanvan_menu_types`
--
ALTER TABLE `luanvan_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `luanvan_messages`
--
ALTER TABLE `luanvan_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_modules`
--
ALTER TABLE `luanvan_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `luanvan_newsfeeds`
--
ALTER TABLE `luanvan_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_overrider`
--
ALTER TABLE `luanvan_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `luanvan_postinstall_messages`
--
ALTER TABLE `luanvan_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `luanvan_redirect_links`
--
ALTER TABLE `luanvan_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_tags`
--
ALTER TABLE `luanvan_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `luanvan_template_styles`
--
ALTER TABLE `luanvan_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `luanvan_ucm_content`
--
ALTER TABLE `luanvan_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_ucm_history`
--
ALTER TABLE `luanvan_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_updates`
--
ALTER TABLE `luanvan_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=62;
--
-- AUTO_INCREMENT for table `luanvan_update_sites`
--
ALTER TABLE `luanvan_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `luanvan_usergroups`
--
ALTER TABLE `luanvan_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `luanvan_users`
--
ALTER TABLE `luanvan_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=173;
--
-- AUTO_INCREMENT for table `luanvan_user_keys`
--
ALTER TABLE `luanvan_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_user_notes`
--
ALTER TABLE `luanvan_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `luanvan_viewlevels`
--
ALTER TABLE `luanvan_viewlevels`
