...
CREATE TABLE COMPONENT_TO_THEME (
  COMPONENT_TO_THEME_ID int(11) NOT NULL AUTO_INCREMENT,
  USERID varchar(30) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  THEMEID int(11) DEFAULT NULL,
  COMPONENTID int(11) DEFAULT NULL,
  COMPONENT_TO_THEME_POLICY varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  PRIMARY KEY (COMPONENT_TO_THEME_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
ALTER TABLE THEME ADD CONSTRAINT FK_THEMEUSERS FOREIGN KEY (USERID) REFERENCES USERS(USERID);
ALTER TABLE COMPONENT ADD CONSTRAINT FK_COMPONENTUSERS FOREIGN KEY (USERID) REFERENCES USERS(USERID);
ALTER TABLE COMPONENT_TO_THEME ADD CONSTRAINT FK_COMPONENTTOTHEMEUSERS FOREIGN KEY (USERID) REFERENCES USERS(USERID);
ALTER TABLE COMPONENT_TO_THEME ADD CONSTRAINT FK_COMPONENTTOTHEMETHEME FOREIGN KEY (THEMEID) REFERENCES THEME(THEMEID);
ALTER TABLE COMPONENT_TO_THEME ADD CONSTRAINT FK_COMPONENTTOTHEMECOMPONENT FOREIGN KEY (COMPONENTID) REFERENCES COMPONENT(COMPONENTID);
