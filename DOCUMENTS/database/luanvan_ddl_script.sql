...
ALTER TABLE USERS ADD CONSTRAINT FK_USERSDEPARTMENT FOREIGN KEY (DEPTID) REFERENCES DEPARTMENT(DEPTID);
ALTER TABLE USERS ADD CONSTRAINT FK_USERSFACULTY FOREIGN KEY (FACID) REFERENCES FACULTY(FACID);
ALTER TABLE USERS ADD CONSTRAINT FK_USERSSCHOOL FOREIGN KEY (SCHID) REFERENCES SCHOOL(SCHID);
