...
--
-- Host: localhost
-- Generation Time: Nov 26, 2018 at 10:14 AM
...
--
ALTER TABLE `USERS`
  ADD CONSTRAINT `FK_USERSDEPARTMENT` FOREIGN KEY (`DEPTID`) REFERENCES `DEPARTMENT` (`DEPTID`),
  ADD CONSTRAINT `FK_USERSFACULTY` FOREIGN KEY (`FACID`) REFERENCES `FACULTY` (`FACID`),
  ADD CONSTRAINT `FK_USERSSCHOOL` FOREIGN KEY (`SCHID`) REFERENCES `SCHOOL` (`SCHID`);
