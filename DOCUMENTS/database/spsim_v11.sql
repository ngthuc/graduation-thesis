...
--
-- Host: localhost
-- Generation Time: Nov 27, 2018 at 06:46 AM
...
(49, 'ngthuc', NULL, NULL, NULL, NULL, NULL, NULL, 'name', NULL, 'Nguyen-Thuc Le', 'public', 'person'),
(50, 'ngthuc', NULL, NULL, NULL, NULL, NULL, NULL, 'position', NULL, 'Student at Department of Software Engineering', 'public', 'person'),
(51, 'ngthuc', NULL, NULL, NULL, NULL, NULL, NULL, 'address', NULL, 'Can Tho', 'public', 'person'),
(52, 'ngthuc', NULL, NULL, NULL, NULL, NULL, '1996-06-26', 'birthday', NULL, NULL, 'public', 'person'),
(53, 'ngthuc', NULL, NULL, NULL, NULL, NULL, NULL, 'gender', NULL, 'Male', 'public', 'person'),
(54, 'ngthuc', NULL, NULL, NULL, NULL, NULL, NULL, 'phone', NULL, '0907355924', 'public', 'person'),
(55, 'ngthuc', NULL, NULL, NULL, NULL, NULL, NULL, 'email', NULL, 'thuc.edu@gmail.com', 'public', 'person'),
(56, 'ngthuc', NULL, NULL, NULL, NULL, NULL, NULL, 'website', NULL, 'http://spsimct594.tk/spsim_media/quyhoach-khu1DHCT.jpg', 'public', 'person'),
(57, 'ngthuc', NULL, NULL, NULL, NULL, 'http://spsimct594.tk/spsim_media/NguyenThuc_DSC_1865_27082018.jpg', NULL, 'avatar', NULL, NULL, 'public', 'person'),
(58, 'ngthuc', NULL, NULL, NULL, 2, NULL, '2004-12-01', 'Ph.D. in computer science on', NULL, 'Visualization and Support Vector Machine in Data Mining<br />LINA, Nantes Laboratory for Computer Science Nantes University, France<br />Thesis advisors: Prof. Henri Briand, Dr. Fran&ccedil;ois Poulet', 'public', 'education'),
(59, 'ngthuc', NULL, NULL, NULL, 3, NULL, '2015-11-01', 'Qualification for Associate Professor (A/Prof.)', NULL, 'Informatics', 'public', 'distinction'),
(60, 'ngthuc', NULL, NULL, NULL, 4, NULL, '2001 - present', 'Data mining and Knowledge discovery in databases', NULL, 'Data mining with SVM and Kernel-based methods, Ensemble methods, Decision tree&nbsp;<br /><br />Information visualization in knowledge discovery in databases, Visual data mining&nbsp;<br /><br />Mining complex data: very-high-dimensional, large scale, imbalanced datasets', 'public', 'research'),
(61, 'ngthuc', NULL, NULL, NULL, 5, NULL, '2012 - 2013', 'Visiting scientist', NULL, 'DECIDE, URM 6285 Lab-STICC, with Prof. Philippe Lenca, A/Prof. Sorin Moga, Telecom-Bretagne, France.<br />Automatic Configuration of Enterprise Resource Planning', 'public', 'experience'),
(62, 'ngthuc', NULL, NULL, NULL, 6, NULL, '2018', 'T-N. Do, F. Poulet', NULL, 'Latent-lSVM classification of very high-dimensional and large scale multi-class datasets. (to appear) in&nbsp;<em>Concurrency and Computation: Practice and Experience</em>, Wiley', 'public', 'journal'),
(63, 'ngthuc', NULL, NULL, NULL, 6, NULL, '2004', 'T-N. Do', NULL, 'Visualisation et s&eacute;parateurs &agrave; vaste marge en fouille de donn&eacute;es. Th&egrave;se de Doctorat de l''Universit&eacute; de Nantes, D&eacute;cembre&nbsp;', 'public', 'thesis'),
(64, 'ngthuc', NULL, NULL, NULL, 7, NULL, '2015-01-01', 'QIMIE 2015 is organized in association with the PAKDD 2015 conference, with Prof. P. Lenca, Prof. S. Lallich', NULL, NULL, 'public', 'workshop'),
(65, 'ngthuc', NULL, NULL, NULL, 6, NULL, '2018', 'T-N. Do, L-D. Bui', NULL, 'Parallel learning algorithms of local support vector regression for dealing with large datasets. (to appear) in The LNCS Journal Transactions on Large-Scale Data- and Knowledge-Centered Systems, Springer', 'public', 'journal');
...
('me', NULL, NULL, NULL, 'Lê Nguyên Thức', 'me@ngthuc.com', NULL, NULL, 'user', 'pending'),
('ngthuc', NULL, NULL, NULL, 'Nguyên Thức', 'ngthuc@lapvo3.tk', NULL, '21232f297a57a5a743894a0e4a801fc3', 'admin', 'approved'),
('ngthuc.hrm', NULL, NULL, NULL, 'HRM Nguyen Thuc', 'ngthuc.hrm@lapvo3.tk', NULL, NULL, 'user', 'approved');
...
--
ALTER TABLE `DEPARTMENT`
  MODIFY `DEPTID` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
