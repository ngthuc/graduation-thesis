...
--
-- Host: localhost
-- Generation Time: Nov 07, 2018 at 03:06 AM
...
INSERT INTO `CATEGORY` (`CATEID`, `USERID`, `CAT_CATEID`, `CATENAME`, `CATENAME_ENGLISH`, `CATELEVEL`, `CATESHOWMENU`, `CATEPOLICY`, `CATETYPE`) VALUES
(1, 'ngthuc', 0, 'Nghiên cứu khoa học', 'Science Research', 1, NULL, 'public', 'article'),
(2, 'ngthuc', 1, 'Đề tài nghiên cứu cấp Nhà nước', 'State level research project', 2, NULL, 'only_me', 'article'),
(3, 'ngthuc', 2, 'Đề tài nghiên cứu cấp Nhà nước đã hoàn thành', 'Completed of State level research project', 3, NULL, 'only_me', 'article'),
(4, 'ngthuc', 0, 'Thông tin cá nhân', 'Person Infomation', 1, NULL, 'public', 'info'),
(5, 'ngthuc', 0, 'Giáo dục', 'Education', 1, NULL, 'public', 'info'),
(6, 'ngthuc', 0, 'Hướng nghiên cứu', 'Research interests', 1, NULL, 'public', 'info'),
(7, 'ngthuc', 0, 'Kinh nghiệm', 'Experience', 1, NULL, 'public', 'info'),
(8, 'ngthuc', 0, 'Công bố', 'Publications', 1, NULL, 'public', 'info'),
(9, 'ngthuc', 0, '', 'Professional Service', 1, NULL, 'public', 'info'),
(10, 'ngthuc', 0, '', 'Distinction', 1, NULL, 'public', 'info'),
(11, 'ngthuc', 0, '', 'SOFTWARE PRODUCTS', 1, NULL, 'public', 'info'),
(12, 'ngthuc', 0, '', 'PROJECTS', 1, NULL, 'public', 'info');
...
INSERT INTO `INFO` (`INFOID`, `USERID`, `CATEID`, `INFOIMAGE`, `INFODATE`, `INFOTITLE`, `INFOTITLE_ENGLISH`, `INFODESCRIPTION`, `INFODESCRIPTION_ENGLISH`, `INFOCONTENT`, `INFOCONTENT_ENGLISH`, `INFOPOLICY`, `INFOTYPE`) VALUES
(1, 'ngthuc', 4, NULL, NULL, 'Giới tính', 'Gender', 'fa-transgender-alt', NULL, 'Nam', 'Male', 'public', 'person'),
(2, 'ngthuc', 4, NULL, NULL, 'Email', 'Email', 'fa-envelope', NULL, 'ngthuc@lapvo3.tk', 'ngthuc@lapvo3.tk', 'public', 'person');
...
--
ALTER TABLE `CATEGORY`
  MODIFY `CATEID` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `INFO`
--
ALTER TABLE `INFO`
  MODIFY `INFOID` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
