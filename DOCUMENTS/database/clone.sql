...
ALTER TABLE `USERS`
  ...
  ADD KEY `FK_USERDEPT` (`DEPTID`),
  ADD KEY `FK_USERFAC` (`FACID`);
  ADD KEY `FK_USERSCH` (`SCHID`);
...
--
ALTER TABLE `USERS`
  ADD CONSTRAINT `FK_USERSCH` FOREIGN KEY (`SCHID`) REFERENCES `USERS` (`SCHID`);
  ADD CONSTRAINT `FK_USERFAC` FOREIGN KEY (`FACID`) REFERENCES `USERS` (`FACID`);
  ADD CONSTRAINT `FK_USERDEPT` FOREIGN KEY (`DEPTID`) REFERENCES `USERS` (`DEPTID`);
